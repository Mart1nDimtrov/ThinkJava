...
Hint:Design a Geniusclass that extends  Playerand overrides the  play method, and
...
static class Eights {
    ...
    public void Score(int winner){
        ...
        System.out.println(one.name + " has won " + this.firstScore + " games.");
        System.out.println(two.name + " has won " + this.secondScore + " games.");
